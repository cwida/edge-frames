...
import partitioning.{AllTuples, RoundRobin, SharesRange}
import testing.Utils._

class RounRobinPartitioning extends FlatSpec with CorrectnessTest with BeforeAndAfterAll {
  ...
  override def beforeAll(): Unit = {
    ...
    wcojConfig.setPartitioning(RoundRobin(0))
